...
<form action="<?php echo site_url('mod/lessons/'.$param3.'/edit'.'/'.$param2); ?>" method="post" enctype="multipart/form-data">
...
function ajax_get_section(course_id) {
    $.ajax({
        url: '<?php echo site_url('mod/ajax_get_section/');?>' + course_id ,
