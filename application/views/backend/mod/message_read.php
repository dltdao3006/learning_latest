	    ...
	    <div class="card">
	        <div class="card-body">
	            ...
	            <div class="chat-conversation">
	                ...
	                <form method="post" action="<?php echo site_url('mod/message/send_reply/'.$current_message_thread_code); ?>" class="needs-validation" novalidate name="chat-form" id="chat-form">
	                    <div class="row">
	                        <div class="col">
...
<script type="text/javascript">
    $(document).ready(function() {
        // 1. Hàm cuộn xuống tin nhắn mới nhất
        ...
        // Cuộn xuống ngay khi vào trang
        scrollToBottom();

        // 2. Tự động kiểm tra tin nhắn mới mỗi 3 giây (AJAX Polling)
		setInterval(function() {
		    var current_thread_code = "<?php echo $current_message_thread_code; ?>";
		    $.ajax({
		        url: "<?php echo site_url('mod/message/message_read/'); ?>" + current_thread_code,
