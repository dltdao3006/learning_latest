...
class Mod extends CI_Controller {
  ...
  public function index() {
    if ($this->session->userdata('mod_login') == true) {
      $this->dashboard();
    }else {
  ...
  public function categories($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'add') {
      ...
      redirect(site_url('mod/categories'), 'refresh');
    }
    elseif ($param1 == "edit") {
  ...
  public function sub_categories_by_category_id($category_id = 0) {
    ...
    redirect(site_url("mod/sub_categories/$category_id"), 'refresh');
  }
  ...
  public function users($param1 = "", $param2 = "") {
    ...
    if ($param1 == "add") {
      ...
      redirect(site_url('mod/users'), 'refresh');
    }
    elseif ($param1 == "edit") {
  ...
  public function enrol_student($param1 = "") {
    ...
    if ($param1 == 'enrol') {
      ...
      redirect(site_url('mod/enrol_history'), 'refresh');
    }
  ...
  //   redirect(site_url('mod/'.$redirect_to), 'refresh');
  // }
  ...
  //     redirect(site_url('mod/system_settings'), 'refresh');
  //   }
  ...
  //     redirect(site_url('mod/frontend_settings'), 'refresh');
  //   }
  ...
  //     redirect(site_url('mod/payment_settings'), 'refresh');
  //   }
  ...
  //     redirect(site_url('mod/smtp_settings'), 'refresh');
  //   }
  ...
  //     redirect(site_url('mod/instructor_settings'), 'refresh');
  //   }
  ...
  public function course_actions($param1 = "", $param2 = "") {
    ...
    if ($param1 == "add") {
      ...
      redirect(site_url('mod/courses'), 'refresh');
  ...
  public function change_course_status($updated_status = "") {
    ...
    redirect(site_url('mod/courses?category_id='.$category_id.'&status='.$status.'&instructor_id='.$instructor_id.'&price='.$price), 'refresh');
  }
  ...
  public function sections($param1 = "", $param2 = "", $param3 = "") {
    ...
    redirect(site_url('mod/course_form/course_edit/'.$param1));
  }
  ...
  public function lessons($course_id = "", $param1 = "", $param2 = "") {
    ...
    if ($param1 == 'add') {
      ...
      redirect('mod/course_form/course_edit/'.$course_id);
    }
    elseif ($param1 == 'edit') {
    ...
    elseif ($param1 == 'filter') {
      redirect('mod/lessons/'.$this->input->post('course_id'));
    }
  ...
  public function manage_language($param1 = '', $param2 = '', $param3 = ''){
    if ($param1 == 'add_language') {
      ...
      redirect(site_url('mod/manage_language'), 'refresh');
    }
  ...
  {
    if ($this->session->userdata('mod_login') != 1)
    redirect(site_url('login'), 'refresh');
    if ($param1 == 'send_new') {
      $message_thread_code = $this->crud_model->send_new_private_message();
      $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
      // redirect(site_url('mod/message/message_read/' . $message_thread_code), 'refresh');
      redirect(site_url('mod/message/message_read/' . $message_thread_code . '?t='.time()), 'refresh');
    }

    if ($param1 == 'send_reply') {
      $this->crud_model->send_reply_message($param2); //$param2 = message_thread_code
      $this->session->set_flashdata('flash_message', get_phrase('message_sent!'));
      // redirect(site_url('mod/message/message_read/' . $param2), 'refresh');
      redirect(site_url('mod/message/message_read/' . $param2 . '?t='.time()), 'refresh');
    }
  ...
  function manage_profile($param1 = '', $param2 = '', $param3 = '')
  {
    ...
    if ($param1 == 'update_profile_info') {
      $this->user_model->edit_user($param2);
      redirect(site_url('mod/manage_profile'), 'refresh');
    }
  ...
  public function paypal_checkout_for_instructor_revenue() {
    ...
    $this->load->view('backend/mod/paypal_checkout_for_instructor_revenue', $page_data);
  }
  ...
  public function stripe_checkout_for_instructor_revenue() {
    ...
    $this->load->view('backend/mod/stripe_checkout_for_instructor_revenue', $page_data);
  }
  ...
  public function payment_success($payment_type = "", $payment_id = "") {
    ...
    redirect(site_url('mod/instructor_revenue'), 'refresh');
  }
  ...
  public function quizes($course_id = "", $action = "", $quiz_id = "") {
    ...
    redirect(site_url('mod/course_form/course_edit/'.$course_id));
  }
  ...
  public function quiz_questions($quiz_id = "", $action = "", $question_id = "") {
    ...
    elseif ($action == 'delete') {
      ...
      redirect(site_url('mod/course_form/course_edit/'.$quiz_details['course_id']));
    }
  }
  ...
  public function ajax_get_sub_category($category_id) {
      ...
      // Dùng view của admin cho an toàn
